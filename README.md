...
## Testing
The testing steps I took to ensure quality include:
    - Resizing the browser a lot while looking at all elements to ensure they were visible and usable.
    - Adding and removing items from the cart while watching the console for confirmation of cart count (array count).
    - Using multiple types of browsers, including mobile, and multiple different tablets.
    - Submitting e-mails to ensure the alert worked properly.
    - Finding the perfect width for the scarf items by finding the appropriate size in conjunction with the text.
